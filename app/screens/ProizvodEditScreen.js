...
function ProizvodEditScreen({ navigation }) {
  const { state, izmjenaProizvoda, obrisiProizvod, clearErrorMessage } =
  ...
  return (
    <SafeAreaView style={styles.container}>
      <TextInput
        ...
        style={styles.input}
        value={naziv}
        onChangeText={(im) => setNaziv(im.trim())}
        onPress={(im) => setSNaziv(im)}
      ></TextInput>
      <TextInput
        autoCapitalize="none"
        label="Količina"
        ...
        style={styles.input}
        value={kolicina}
        onChangeText={(pre) => setKolicina(pre.trim())}
        onPress={(im) => setSNaziv(im)}
      ></TextInput>
      <TextInput
        autoCapitalize="none"
        ...
        style={styles.input}
        value={jedinica}
        onChangeText={(jmbg) => setJedinica(jmbg.trim())}
        onPress={(im) => setSNaziv(im)}
      ></TextInput>
