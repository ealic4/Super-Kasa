  ...
  return (
    <NavigationContainer ref={navigationRef}>
      ...
      >
        ...
        <Stack.Screen
          name="PoslovnicaDodaj"
          component={DodavanjePoslovnicaScreen}
        />
        <Stack.Screen
          name="PoslovnicaDodajProizvod"
          component={UvodjenjeProizvodaUPoslovniceScreen}
        />

        <Stack.Screen
          name="ListaPoslovnica"
          component={ListaPoslovnicaScreen}
        />
        <Stack.Screen name="ProizvodEdit" component={ProizvodEditScreen} />

        <Stack.Screen
          name="SkladisteDodajProizvod"
          component={DodajProizvodSkladisteScreen}
        />
        <Stack.Screen
          name="ProizvodiPoslovnice"
          component={ListaProizvodaUPoslovniciScreen}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
